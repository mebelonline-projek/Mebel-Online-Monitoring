...
// ============================================================
// User input nama pelanggan (teks) → tampil daftar transaksi → centang → buat invoice.
// ============================================================
...
interface TransactionOption { id: string; transaction_number: string; final_price: number; status: string; created_at: string; customer_name: string | null; }
...
export function InvoiceForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (selectedTxIds.size === 0) { toast.error("Pilih minimal 1 transaksi"); return; }
        ...
        {selectedTxIds.size > 0 && (
          <Card className="shadow-sm">
            <CardContent className="p-4">
              <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-2">Ringkasan</p>
