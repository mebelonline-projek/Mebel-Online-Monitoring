...
async function fetchKaryawanDashboardData(): Promise<KaryawanDashboardData> {
...
/** Auth di luar; agregat selalu segar (SPA/Next berbagi DB). */
export async function getKaryawanDashboardData(): Promise<KaryawanDashboardData> {
  ...
  return fetchKaryawanDashboardData();
}
